...
type MakeMapper struct {
	...
	InsertArrayParameterTextString                               func(sid string, source string, items []string) (int, error)
	InsertArrayParameterTextStringOriginalPointer                func(sid string, source string, items []string) (int, error)
	InsertArrayParameterTextStringPointerOriginal                func(sid string, source string, items []*string) (int, error)
	InsertArrayParameterTextStringPointerPointer                 func(sid string, source string, items []*string) (int, error)
	InsertArrayEntityTextString                                  func(sid string, source string, items []*string) (int, error)
	InsertArrayEntityTextStringOriginalPointer                   func(sid string, source string, items []*string) (int, error)
	InsertArrayEntityTextStringPointerOriginal                   func(sid string, source string, items []*string) (int, error)
	InsertArrayEntityTextStringPointerPointer                    func(sid string, source string, items []*string) (int, error)
	...
	InsertArrayParameterTimeTime                                 func(sid string, source string, items []time) (int, error)
	InsertArrayParameterTimeTimeOriginalPointer                  func(sid string, source string, items []time) (int, error)
	InsertArrayParameterTimeTimePointerOriginal                  func(sid string, source string, items []*time) (int, error)
	InsertArrayParameterTimeTimePointerPointer                   func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimeTime                                    func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimeTimeOriginalPointer                     func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimeTimePointerOriginal                     func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimeTimePointerPointer                      func(sid string, source string, items []*time) (int, error)
	...
	InsertArrayParameterTimeWithTimezoneTime                     func(sid string, source string, items []time) (int, error)
	InsertArrayParameterTimeWithTimezoneTimeOriginalPointer      func(sid string, source string, items []time) (int, error)
	InsertArrayParameterTimeWithTimezoneTimePointerOriginal      func(sid string, source string, items []*time) (int, error)
	InsertArrayParameterTimeWithTimezoneTimePointerPointer       func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimeWithTimezoneTime                        func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimeWithTimezoneTimeOriginalPointer         func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimeWithTimezoneTimePointerOriginal         func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimeWithTimezoneTimePointerPointer          func(sid string, source string, items []*time) (int, error)
	...
	InsertArrayParameterTimetzTime                               func(sid string, source string, items []time) (int, error)
	InsertArrayParameterTimetzTimeOriginalPointer                func(sid string, source string, items []time) (int, error)
	InsertArrayParameterTimetzTimePointerOriginal                func(sid string, source string, items []*time) (int, error)
	InsertArrayParameterTimetzTimePointerPointer                 func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimetzTime                                  func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimetzTimeOriginalPointer                   func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimetzTimePointerOriginal                   func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimetzTimePointerPointer                    func(sid string, source string, items []*time) (int, error)
	...
	InsertArrayParameterTimestampTime                            func(sid string, source string, items []time) (int, error)
	InsertArrayParameterTimestampTimeOriginalPointer             func(sid string, source string, items []time) (int, error)
	InsertArrayParameterTimestampTimePointerOriginal             func(sid string, source string, items []*time) (int, error)
	InsertArrayParameterTimestampTimePointerPointer              func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimestampTime                               func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimestampTimeOriginalPointer                func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimestampTimePointerOriginal                func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimestampTimePointerPointer                 func(sid string, source string, items []*time) (int, error)
	...
	InsertArrayParameterTimestampWithTimezoneTime                func(sid string, source string, items []time) (int, error)
	InsertArrayParameterTimestampWithTimezoneTimeOriginalPointer func(sid string, source string, items []time) (int, error)
	InsertArrayParameterTimestampWithTimezoneTimePointerOriginal func(sid string, source string, items []*time) (int, error)
	InsertArrayParameterTimestampWithTimezoneTimePointerPointer  func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimestampWithTimezoneTime                   func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimestampWithTimezoneTimeOriginalPointer    func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimestampWithTimezoneTimePointerOriginal    func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimestampWithTimezoneTimePointerPointer     func(sid string, source string, items []*time) (int, error)
	...
	InsertArrayParameterTimestamptzTime                          func(sid string, source string, items []time) (int, error)
	InsertArrayParameterTimestamptzTimeOriginalPointer           func(sid string, source string, items []time) (int, error)
	InsertArrayParameterTimestamptzTimePointerOriginal           func(sid string, source string, items []*time) (int, error)
	InsertArrayParameterTimestamptzTimePointerPointer            func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimestamptzTime                             func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimestamptzTimeOriginalPointer              func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimestamptzTimePointerOriginal              func(sid string, source string, items []*time) (int, error)
	InsertArrayEntityTimestamptzTimePointerPointer               func(sid string, source string, items []*time) (int, error)
	...
	SelectArrayParameterTextString                               func(sid string) ([]string, error)
	SelectArrayParameterTextStringOriginalPointer                func(sid string) ([]string, error)
	SelectArrayParameterTextStringPointerOriginal                func(sid string) ([]*string, error)
	SelectArrayParameterTextStringPointerPointer                 func(sid string) ([]*string, error)
	SelectArrayEntityTextString                                  func(sid string) ([]*string, error)
	SelectArrayEntityTextStringOriginalPointer                   func(sid string) ([]*string, error)
	SelectArrayEntityTextStringPointerOriginal                   func(sid string) ([]*string, error)
	SelectArrayEntityTextStringPointerPointer                    func(sid string) ([]*string, error)
	...
	SelectArrayParameterTimeTime                                 func(sid string) ([]time, error)
	SelectArrayParameterTimeTimeOriginalPointer                  func(sid string) ([]time, error)
	SelectArrayParameterTimeTimePointerOriginal                  func(sid string) ([]*time, error)
	SelectArrayParameterTimeTimePointerPointer                   func(sid string) ([]*time, error)
	SelectArrayEntityTimeTime                                    func(sid string) ([]*time, error)
	SelectArrayEntityTimeTimeOriginalPointer                     func(sid string) ([]*time, error)
	SelectArrayEntityTimeTimePointerOriginal                     func(sid string) ([]*time, error)
	SelectArrayEntityTimeTimePointerPointer                      func(sid string) ([]*time, error)
	...
	SelectArrayParameterTimeWithTimezoneTime                     func(sid string) ([]time, error)
	SelectArrayParameterTimeWithTimezoneTimeOriginalPointer      func(sid string) ([]time, error)
	SelectArrayParameterTimeWithTimezoneTimePointerOriginal      func(sid string) ([]*time, error)
	SelectArrayParameterTimeWithTimezoneTimePointerPointer       func(sid string) ([]*time, error)
	SelectArrayEntityTimeWithTimezoneTime                        func(sid string) ([]*time, error)
	SelectArrayEntityTimeWithTimezoneTimeOriginalPointer         func(sid string) ([]*time, error)
	SelectArrayEntityTimeWithTimezoneTimePointerOriginal         func(sid string) ([]*time, error)
	SelectArrayEntityTimeWithTimezoneTimePointerPointer          func(sid string) ([]*time, error)
	...
	SelectArrayParameterTimetzTime                               func(sid string) ([]time, error)
	SelectArrayParameterTimetzTimeOriginalPointer                func(sid string) ([]time, error)
	SelectArrayParameterTimetzTimePointerOriginal                func(sid string) ([]*time, error)
	SelectArrayParameterTimetzTimePointerPointer                 func(sid string) ([]*time, error)
	SelectArrayEntityTimetzTime                                  func(sid string) ([]*time, error)
	SelectArrayEntityTimetzTimeOriginalPointer                   func(sid string) ([]*time, error)
	SelectArrayEntityTimetzTimePointerOriginal                   func(sid string) ([]*time, error)
	SelectArrayEntityTimetzTimePointerPointer                    func(sid string) ([]*time, error)
	...
	SelectArrayParameterTimestampTime                            func(sid string) ([]time, error)
	SelectArrayParameterTimestampTimeOriginalPointer             func(sid string) ([]time, error)
	SelectArrayParameterTimestampTimePointerOriginal             func(sid string) ([]*time, error)
	SelectArrayParameterTimestampTimePointerPointer              func(sid string) ([]*time, error)
	SelectArrayEntityTimestampTime                               func(sid string) ([]*time, error)
	SelectArrayEntityTimestampTimeOriginalPointer                func(sid string) ([]*time, error)
	SelectArrayEntityTimestampTimePointerOriginal                func(sid string) ([]*time, error)
	SelectArrayEntityTimestampTimePointerPointer                 func(sid string) ([]*time, error)
	...
	SelectArrayParameterTimestampWithTimezoneTime                func(sid string) ([]time, error)
	SelectArrayParameterTimestampWithTimezoneTimeOriginalPointer func(sid string) ([]time, error)
	SelectArrayParameterTimestampWithTimezoneTimePointerOriginal func(sid string) ([]*time, error)
	SelectArrayParameterTimestampWithTimezoneTimePointerPointer  func(sid string) ([]*time, error)
	SelectArrayEntityTimestampWithTimezoneTime                   func(sid string) ([]*time, error)
	SelectArrayEntityTimestampWithTimezoneTimeOriginalPointer    func(sid string) ([]*time, error)
	SelectArrayEntityTimestampWithTimezoneTimePointerOriginal    func(sid string) ([]*time, error)
	SelectArrayEntityTimestampWithTimezoneTimePointerPointer     func(sid string) ([]*time, error)
	...
	SelectArrayParameterTimestamptzTime                          func(sid string) ([]time, error)
	SelectArrayParameterTimestamptzTimeOriginalPointer           func(sid string) ([]time, error)
	SelectArrayParameterTimestamptzTimePointerOriginal           func(sid string) ([]*time, error)
	SelectArrayParameterTimestamptzTimePointerPointer            func(sid string) ([]*time, error)
	SelectArrayEntityTimestamptzTime                             func(sid string) ([]*time, error)
	SelectArrayEntityTimestamptzTimeOriginalPointer              func(sid string) ([]*time, error)
	SelectArrayEntityTimestamptzTimePointerOriginal              func(sid string) ([]*time, error)
	SelectArrayEntityTimestamptzTimePointerPointer               func(sid string) ([]*time, error)
	...
	UpdateArrayParameterTextString                               func(sid string, source string, items []string) (int, error)
	UpdateArrayParameterTextStringOriginalPointer                func(sid string, source string, items []string) (int, error)
	UpdateArrayParameterTextStringPointerOriginal                func(sid string, source string, items []*string) (int, error)
	UpdateArrayParameterTextStringPointerPointer                 func(sid string, source string, items []*string) (int, error)
	UpdateArrayEntityTextString                                  func(item TextOriginal) (int, error)
	UpdateArrayEntityTextStringOriginalPointer                   func(item TextPointer) (int, error)
	UpdateArrayEntityTextStringPointerOriginal                   func(item TextOriginal) (int, error)
	UpdateArrayEntityTextStringPointerPointer                    func(item TextPointer) (int, error)
	...
	UpdateArrayParameterTimeTime                                 func(sid string, source string, items []time) (int, error)
	UpdateArrayParameterTimeTimeOriginalPointer                  func(sid string, source string, items []time) (int, error)
	UpdateArrayParameterTimeTimePointerOriginal                  func(sid string, source string, items []*time) (int, error)
	UpdateArrayParameterTimeTimePointerPointer                   func(sid string, source string, items []*time) (int, error)
	UpdateArrayEntityTimeTime                                    func(item TimeOriginal) (int, error)
	UpdateArrayEntityTimeTimeOriginalPointer                     func(item TimePointer) (int, error)
	UpdateArrayEntityTimeTimePointerOriginal                     func(item TimeOriginal) (int, error)
	UpdateArrayEntityTimeTimePointerPointer                      func(item TimePointer) (int, error)
	...
	UpdateArrayParameterTimeWithTimezoneTime                     func(sid string, source string, items []time) (int, error)
	UpdateArrayParameterTimeWithTimezoneTimeOriginalPointer      func(sid string, source string, items []time) (int, error)
	UpdateArrayParameterTimeWithTimezoneTimePointerOriginal      func(sid string, source string, items []*time) (int, error)
	UpdateArrayParameterTimeWithTimezoneTimePointerPointer       func(sid string, source string, items []*time) (int, error)
	UpdateArrayEntityTimeWithTimezoneTime                        func(item TimeWithTimezoneOriginal) (int, error)
	UpdateArrayEntityTimeWithTimezoneTimeOriginalPointer         func(item TimeWithTimezonePointer) (int, error)
	UpdateArrayEntityTimeWithTimezoneTimePointerOriginal         func(item TimeWithTimezoneOriginal) (int, error)
	UpdateArrayEntityTimeWithTimezoneTimePointerPointer          func(item TimeWithTimezonePointer) (int, error)
	...
	UpdateArrayParameterTimetzTime                               func(sid string, source string, items []time) (int, error)
	UpdateArrayParameterTimetzTimeOriginalPointer                func(sid string, source string, items []time) (int, error)
	UpdateArrayParameterTimetzTimePointerOriginal                func(sid string, source string, items []*time) (int, error)
	UpdateArrayParameterTimetzTimePointerPointer                 func(sid string, source string, items []*time) (int, error)
	UpdateArrayEntityTimetzTime                                  func(item TimetzOriginal) (int, error)
	UpdateArrayEntityTimetzTimeOriginalPointer                   func(item TimetzPointer) (int, error)
	UpdateArrayEntityTimetzTimePointerOriginal                   func(item TimetzOriginal) (int, error)
	UpdateArrayEntityTimetzTimePointerPointer                    func(item TimetzPointer) (int, error)
	...
	UpdateArrayParameterTimestampTime                            func(sid string, source string, items []time) (int, error)
	UpdateArrayParameterTimestampTimeOriginalPointer             func(sid string, source string, items []time) (int, error)
	UpdateArrayParameterTimestampTimePointerOriginal             func(sid string, source string, items []*time) (int, error)
	UpdateArrayParameterTimestampTimePointerPointer              func(sid string, source string, items []*time) (int, error)
	UpdateArrayEntityTimestampTime                               func(item TimestampOriginal) (int, error)
	UpdateArrayEntityTimestampTimeOriginalPointer                func(item TimestampPointer) (int, error)
	UpdateArrayEntityTimestampTimePointerOriginal                func(item TimestampOriginal) (int, error)
	UpdateArrayEntityTimestampTimePointerPointer                 func(item TimestampPointer) (int, error)
	...
	UpdateArrayParameterTimestampWithTimezoneTime                func(sid string, source string, items []time) (int, error)
	UpdateArrayParameterTimestampWithTimezoneTimeOriginalPointer func(sid string, source string, items []time) (int, error)
	UpdateArrayParameterTimestampWithTimezoneTimePointerOriginal func(sid string, source string, items []*time) (int, error)
	UpdateArrayParameterTimestampWithTimezoneTimePointerPointer  func(sid string, source string, items []*time) (int, error)
	UpdateArrayEntityTimestampWithTimezoneTime                   func(item TimestampWithTimezoneOriginal) (int, error)
	UpdateArrayEntityTimestampWithTimezoneTimeOriginalPointer    func(item TimestampWithTimezonePointer) (int, error)
	UpdateArrayEntityTimestampWithTimezoneTimePointerOriginal    func(item TimestampWithTimezoneOriginal) (int, error)
	UpdateArrayEntityTimestampWithTimezoneTimePointerPointer     func(item TimestampWithTimezonePointer) (int, error)
	...
	UpdateArrayParameterTimestamptzTime                          func(sid string, source string, items []time) (int, error)
	UpdateArrayParameterTimestamptzTimeOriginalPointer           func(sid string, source string, items []time) (int, error)
	UpdateArrayParameterTimestamptzTimePointerOriginal           func(sid string, source string, items []*time) (int, error)
	UpdateArrayParameterTimestamptzTimePointerPointer            func(sid string, source string, items []*time) (int, error)
	UpdateArrayEntityTimestamptzTime                             func(item TimestamptzOriginal) (int, error)
	UpdateArrayEntityTimestamptzTimeOriginalPointer              func(item TimestamptzPointer) (int, error)
	UpdateArrayEntityTimestamptzTimePointerOriginal              func(item TimestamptzOriginal) (int, error)
	UpdateArrayEntityTimestamptzTimePointerPointer               func(item TimestamptzPointer) (int, error)
	...
	DeleteArrayParameterTextString                               func(sid string) (int, error)
	DeleteArrayParameterTextStringOriginalPointer                func(sid string) (int, error)
	DeleteArrayParameterTextStringPointerOriginal                func(sid string) (int, error)
	DeleteArrayParameterTextStringPointerPointer                 func(sid string) (int, error)
	DeleteArrayEntityTextString                                  func(sid string) (int, error)
	DeleteArrayEntityTextStringOriginalPointer                   func(sid string) (int, error)
	DeleteArrayEntityTextStringPointerOriginal                   func(sid string) (int, error)
	DeleteArrayEntityTextStringPointerPointer                    func(sid string) (int, error)
	...
	DeleteArrayParameterTimeTime                                 func(sid string) (int, error)
	DeleteArrayParameterTimeTimeOriginalPointer                  func(sid string) (int, error)
	DeleteArrayParameterTimeTimePointerOriginal                  func(sid string) (int, error)
	DeleteArrayParameterTimeTimePointerPointer                   func(sid string) (int, error)
	DeleteArrayEntityTimeTime                                    func(sid string) (int, error)
	DeleteArrayEntityTimeTimeOriginalPointer                     func(sid string) (int, error)
	DeleteArrayEntityTimeTimePointerOriginal                     func(sid string) (int, error)
	DeleteArrayEntityTimeTimePointerPointer                      func(sid string) (int, error)
	...
	DeleteArrayParameterTimeWithTimezoneTime                     func(sid string) (int, error)
	DeleteArrayParameterTimeWithTimezoneTimeOriginalPointer      func(sid string) (int, error)
	DeleteArrayParameterTimeWithTimezoneTimePointerOriginal      func(sid string) (int, error)
	DeleteArrayParameterTimeWithTimezoneTimePointerPointer       func(sid string) (int, error)
	DeleteArrayEntityTimeWithTimezoneTime                        func(sid string) (int, error)
	DeleteArrayEntityTimeWithTimezoneTimeOriginalPointer         func(sid string) (int, error)
	DeleteArrayEntityTimeWithTimezoneTimePointerOriginal         func(sid string) (int, error)
	DeleteArrayEntityTimeWithTimezoneTimePointerPointer          func(sid string) (int, error)
	...
	DeleteArrayParameterTimetzTime                               func(sid string) (int, error)
	DeleteArrayParameterTimetzTimeOriginalPointer                func(sid string) (int, error)
	DeleteArrayParameterTimetzTimePointerOriginal                func(sid string) (int, error)
	DeleteArrayParameterTimetzTimePointerPointer                 func(sid string) (int, error)
	DeleteArrayEntityTimetzTime                                  func(sid string) (int, error)
	DeleteArrayEntityTimetzTimeOriginalPointer                   func(sid string) (int, error)
	DeleteArrayEntityTimetzTimePointerOriginal                   func(sid string) (int, error)
	DeleteArrayEntityTimetzTimePointerPointer                    func(sid string) (int, error)
	...
	DeleteArrayParameterTimestampTime                            func(sid string) (int, error)
	DeleteArrayParameterTimestampTimeOriginalPointer             func(sid string) (int, error)
	DeleteArrayParameterTimestampTimePointerOriginal             func(sid string) (int, error)
	DeleteArrayParameterTimestampTimePointerPointer              func(sid string) (int, error)
	DeleteArrayEntityTimestampTime                               func(sid string) (int, error)
	DeleteArrayEntityTimestampTimeOriginalPointer                func(sid string) (int, error)
	DeleteArrayEntityTimestampTimePointerOriginal                func(sid string) (int, error)
	DeleteArrayEntityTimestampTimePointerPointer                 func(sid string) (int, error)
	...
	DeleteArrayParameterTimestampWithTimezoneTime                func(sid string) (int, error)
	DeleteArrayParameterTimestampWithTimezoneTimeOriginalPointer func(sid string) (int, error)
	DeleteArrayParameterTimestampWithTimezoneTimePointerOriginal func(sid string) (int, error)
	DeleteArrayParameterTimestampWithTimezoneTimePointerPointer  func(sid string) (int, error)
	DeleteArrayEntityTimestampWithTimezoneTime                   func(sid string) (int, error)
	DeleteArrayEntityTimestampWithTimezoneTimeOriginalPointer    func(sid string) (int, error)
	DeleteArrayEntityTimestampWithTimezoneTimePointerOriginal    func(sid string) (int, error)
	DeleteArrayEntityTimestampWithTimezoneTimePointerPointer     func(sid string) (int, error)
	...
	DeleteArrayParameterTimestamptzTime                          func(sid string) (int, error)
	DeleteArrayParameterTimestamptzTimeOriginalPointer           func(sid string) (int, error)
	DeleteArrayParameterTimestamptzTimePointerOriginal           func(sid string) (int, error)
	DeleteArrayParameterTimestamptzTimePointerPointer            func(sid string) (int, error)
	DeleteArrayEntityTimestamptzTime                             func(sid string) (int, error)
	DeleteArrayEntityTimestamptzTimeOriginalPointer              func(sid string) (int, error)
	DeleteArrayEntityTimestamptzTimePointerOriginal              func(sid string) (int, error)
	DeleteArrayEntityTimestamptzTimePointerPointer               func(sid string) (int, error)
}
