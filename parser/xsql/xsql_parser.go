...
func xsqlParserInit() {
	...
	staticData.serializedATN = []int32{
		...
		2, 4, 6, 8, 10, 12, 0, 1, 9, 0, 1, 1, 3, 3, 5, 5, 7, 7, 9, 9, 11, 11, 13,
		13, 15, 15, 19, 30, 243, 0, 14, 1, 0, 0, 0, 2, 23, 1, 0, 0, 0, 4, 170,
		1, 0, 0, 0, 6, 172, 1, 0, 0, 0, 8, 185, 1, 0, 0, 0, 10, 213, 1, 0, 0, 0,
		12, 215, 1, 0, 0, 0, 14, 15, 3, 2, 1, 0, 15, 16, 5, 0, 0, 1, 16, 1, 1,
		0, 0, 0, 17, 22, 3, 4, 2, 0, 18, 22, 3, 8, 4, 0, 19, 22, 3, 10, 5, 0, 20,
		22, 3, 12, 6, 0, 21, 17, 1, 0, 0, 0, 21, 18, 1, 0, 0, 0, 21, 19, 1, 0,
		0, 0, 21, 20, 1, 0, 0, 0, 22, 25, 1, 0, 0, 0, 23, 21, 1, 0, 0, 0, 23, 24,
		1, 0, 0, 0, 24, 3, 1, 0, 0, 0, 25, 23, 1, 0, 0, 0, 26, 27, 5, 25, 0, 0,
		27, 31, 5, 1, 0, 0, 28, 30, 5, 19, 0, 0, 29, 28, 1, 0, 0, 0, 30, 33, 1,
		0, 0, 0, 31, 29, 1, 0, 0, 0, 31, 32, 1, 0, 0, 0, 32, 37, 1, 0, 0, 0, 33,
		31, 1, 0, 0, 0, 34, 36, 3, 6, 3, 0, 35, 34, 1, 0, 0, 0, 36, 39, 1, 0, 0,
		0, 37, 35, 1, 0, 0, 0, 37, 38, 1, 0, 0, 0, 38, 40, 1, 0, 0, 0, 39, 37,
		1, 0, 0, 0, 40, 41, 5, 26, 0, 0, 41, 42, 3, 2, 1, 0, 42, 43, 5, 2, 0, 0,
		43, 171, 1, 0, 0, 0, 44, 45, 5, 25, 0, 0, 45, 49, 5, 3, 0, 0, 46, 48, 5,
		19, 0, 0, 47, 46, 1, 0, 0, 0, 48, 51, 1, 0, 0, 0, 49, 47, 1, 0, 0, 0, 49,
		50, 1, 0, 0, 0, 50, 55, 1, 0, 0, 0, 51, 49, 1, 0, 0, 0, 52, 54, 3, 6, 3,
		0, 53, 52, 1, 0, 0, 0, 54, 57, 1, 0, 0, 0, 55, 53, 1, 0, 0, 0, 55, 56,
		1, 0, 0, 0, 56, 58, 1, 0, 0, 0, 57, 55, 1, 0, 0, 0, 58, 59, 5, 26, 0, 0,
		59, 60, 3, 2, 1, 0, 60, 61, 5, 4, 0, 0, 61, 171, 1, 0, 0, 0, 62, 63, 5,
		25, 0, 0, 63, 67, 5, 5, 0, 0, 64, 66, 5, 19, 0, 0, 65, 64, 1, 0, 0, 0,
		66, 69, 1, 0, 0, 0, 67, 65, 1, 0, 0, 0, 67, 68, 1, 0, 0, 0, 68, 73, 1,
		0, 0, 0, 69, 67, 1, 0, 0, 0, 70, 72, 3, 6, 3, 0, 71, 70, 1, 0, 0, 0, 72,
		75, 1, 0, 0, 0, 73, 71, 1, 0, 0, 0, 73, 74, 1, 0, 0, 0, 74, 76, 1, 0, 0,
		0, 75, 73, 1, 0, 0, 0, 76, 77, 5, 26, 0, 0, 77, 78, 3, 2, 1, 0, 78, 79,
		5, 6, 0, 0, 79, 171, 1, 0, 0, 0, 80, 81, 5, 25, 0, 0, 81, 85, 5, 7, 0,
		0, 82, 84, 5, 19, 0, 0, 83, 82, 1, 0, 0, 0, 84, 87, 1, 0, 0, 0, 85, 83,
		1, 0, 0, 0, 85, 86, 1, 0, 0, 0, 86, 91, 1, 0, 0, 0, 87, 85, 1, 0, 0, 0,
		88, 90, 3, 6, 3, 0, 89, 88, 1, 0, 0, 0, 90, 93, 1, 0, 0, 0, 91, 89, 1,
		0, 0, 0, 91, 92, 1, 0, 0, 0, 92, 94, 1, 0, 0, 0, 93, 91, 1, 0, 0, 0, 94,
		95, 5, 26, 0, 0, 95, 96, 3, 2, 1, 0, 96, 97, 5, 8, 0, 0, 97, 171, 1, 0,
		0, 0, 98, 99, 5, 25, 0, 0, 99, 103, 5, 9, 0, 0, 100, 102, 5, 19, 0, 0,
		101, 100, 1, 0, 0, 0, 102, 105, 1, 0, 0, 0, 103, 101, 1, 0, 0, 0, 103,
		104, 1, 0, 0, 0, 104, 109, 1, 0, 0, 0, 105, 103, 1, 0, 0, 0, 106, 108,
		3, 6, 3, 0, 107, 106, 1, 0, 0, 0, 108, 111, 1, 0, 0, 0, 109, 107, 1, 0,
		0, 0, 109, 110, 1, 0, 0, 0, 110, 112, 1, 0, 0, 0, 111, 109, 1, 0, 0, 0,
		112, 113, 5, 26, 0, 0, 113, 114, 3, 2, 1, 0, 114, 115, 5, 10, 0, 0, 115,
		171, 1, 0, 0, 0, 116, 117, 5, 25, 0, 0, 117, 121, 5, 11, 0, 0, 118, 120,
		5, 19, 0, 0, 119, 118, 1, 0, 0, 0, 120, 123, 1, 0, 0, 0, 121, 119, 1, 0,
		0, 0, 121, 122, 1, 0, 0, 0, 122, 127, 1, 0, 0, 0, 123, 121, 1, 0, 0, 0,
		124, 126, 3, 6, 3, 0, 125, 124, 1, 0, 0, 0, 126, 129, 1, 0, 0, 0, 127,
		125, 1, 0, 0, 0, 127, 128, 1, 0, 0, 0, 128, 130, 1, 0, 0, 0, 129, 127,
		1, 0, 0, 0, 130, 131, 5, 26, 0, 0, 131, 132, 3, 2, 1, 0, 132, 133, 5, 12,
		0, 0, 133, 171, 1, 0, 0, 0, 134, 135, 5, 25, 0, 0, 135, 139, 5, 13, 0,
		0, 136, 138, 5, 19, 0, 0, 137, 136, 1, 0, 0, 0, 138, 141, 1, 0, 0, 0, 139,
		137, 1, 0, 0, 0, 139, 140, 1, 0, 0, 0, 140, 145, 1, 0, 0, 0, 141, 139,
		1, 0, 0, 0, 142, 144, 3, 6, 3, 0, 143, 142, 1, 0, 0, 0, 144, 147, 1, 0,
		0, 0, 145, 143, 1, 0, 0, 0, 145, 146, 1, 0, 0, 0, 146, 148, 1, 0, 0, 0,
		147, 145, 1, 0, 0, 0, 148, 149, 5, 26, 0, 0, 149, 150, 3, 2, 1, 0, 150,
		151, 5, 14, 0, 0, 151, 171, 1, 0, 0, 0, 152, 153, 5, 25, 0, 0, 153, 157,
		5, 15, 0, 0, 154, 156, 5, 19, 0, 0, 155, 154, 1, 0, 0, 0, 156, 159, 1,
		0, 0, 0, 157, 155, 1, 0, 0, 0, 157, 158, 1, 0, 0, 0, 158, 163, 1, 0, 0,
		0, 159, 157, 1, 0, 0, 0, 160, 162, 3, 6, 3, 0, 161, 160, 1, 0, 0, 0, 162,
		165, 1, 0, 0, 0, 163, 161, 1, 0, 0, 0, 163, 164, 1, 0, 0, 0, 164, 166,
		1, 0, 0, 0, 165, 163, 1, 0, 0, 0, 166, 167, 5, 26, 0, 0, 167, 168, 3, 2,
		1, 0, 168, 169, 5, 16, 0, 0, 169, 171, 1, 0, 0, 0, 170, 26, 1, 0, 0, 0,
		170, 44, 1, 0, 0, 0, 170, 62, 1, 0, 0, 0, 170, 80, 1, 0, 0, 0, 170, 98,
		1, 0, 0, 0, 170, 116, 1, 0, 0, 0, 170, 134, 1, 0, 0, 0, 170, 152, 1, 0,
		0, 0, 171, 5, 1, 0, 0, 0, 172, 173, 5, 20, 0, 0, 173, 174, 5, 28, 0, 0,
		174, 178, 5, 29, 0, 0, 175, 177, 5, 19, 0, 0, 176, 175, 1, 0, 0, 0, 177,
		180, 1, 0, 0, 0, 178, 176, 1, 0, 0, 0, 178, 179, 1, 0, 0, 0, 179, 7, 1,
		0, 0, 0, 180, 178, 1, 0, 0, 0, 181, 182, 5, 21, 0, 0, 182, 186, 5, 23,
		0, 0, 183, 184, 5, 22, 0, 0, 184, 186, 5, 23, 0, 0, 185, 181, 1, 0, 0,
		0, 185, 183, 1, 0, 0, 0, 186, 190, 1, 0, 0, 0, 187, 189, 5, 19, 0, 0, 188,
		187, 1, 0, 0, 0, 189, 192, 1, 0, 0, 0, 190, 188, 1, 0, 0, 0, 190, 191,
		1, 0, 0, 0, 191, 196, 1, 0, 0, 0, 192, 190, 1, 0, 0, 0, 193, 195, 5, 20,
		0, 0, 194, 193, 1, 0, 0, 0, 195, 198, 1, 0, 0, 0, 196, 194, 1, 0, 0, 0,
		196, 197, 1, 0, 0, 0, 197, 202, 1, 0, 0, 0, 198, 196, 1, 0, 0, 0, 199,
		201, 5, 30, 0, 0, 200, 199, 1, 0, 0, 0, 201, 204, 1, 0, 0, 0, 202, 200,
		1, 0, 0, 0, 202, 203, 1, 0, 0, 0, 203, 208, 1, 0, 0, 0, 204, 202, 1, 0,
		0, 0, 205, 207, 5, 19, 0, 0, 206, 205, 1, 0, 0, 0, 207, 210, 1, 0, 0, 0,
		208, 206, 1, 0, 0, 0, 208, 209, 1, 0, 0, 0, 209, 211, 1, 0, 0, 0, 210,
		208, 1, 0, 0, 0, 211, 212, 5, 24, 0, 0, 212, 9, 1, 0, 0, 0, 213, 214, 5,
		18, 0, 0, 214, 11, 1, 0, 0, 0, 215, 216, 7, 0, 0, 0, 216, 13, 1, 0, 0,
		0, 25, 21, 23, 31, 37, 49, 55, 67, 73, 85, 91, 103, 109, 121, 127, 139,
		145, 157, 163, 170, 178, 185, 190, 196, 202, 208,
	}
...
func (p *XSQLParser) Content() (localctx IContentContext) {
	...
	for (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&2147265194) != 0 {
		p.SetState(21)
		p.GetErrorHandler().Sync(p)
		if p.HasError() {
			goto errorExit
...
func (p *XSQLParser) Chardata() (localctx IChardataContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&2147003050) != 0) {
